// vendored as-is from pixeltris/TwitchAdSolutions vaft-ublock-origin.js (先頭の uBO ヘッダ行のみ除去)。
// Twitch の広告スワップ(Worker フック→広告検知→広告無しストリームに差し替え)。
// manifest で twitch.tv の MAIN world / document_start / all_frames に注入する。
(function() {
