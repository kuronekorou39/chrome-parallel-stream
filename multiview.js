...
// 枠ヘッダ/ボタンの一時表示の自動消去。操作が無ければ完全に消す(映像に重ねない)。
// タッチはマウスと違って「離れる」動作が無いので長めに取っていたが、枠のどこをタップしても
// 出せるようになった(tile-tap)ので、出しっぱなしの方が邪魔になった。半分に縮める。
const BAR_HIDE_MS = IS_COARSE ? 6000 : 4000;
...
const EXPECTED_EXT_VERSION = '0.9.55';
